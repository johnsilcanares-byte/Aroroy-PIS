...
if(isset($_POST['save_medicine'])) {
    ...
    if($medicineName !== '' && $id > 0) {
        try {
            $con->beginTransaction();

            $stmt = $con->prepare("UPDATE medicines SET medicine_name = :name WHERE id = :id");
            $stmt->bindParam(':name', $medicineName, PDO::PARAM_STR);
            ...
            // For dev, you can uncomment next line
...
try {
    ...
    $stmt = $con->prepare("SELECT id, medicine_name FROM medicines WHERE id = :id");
    $stmt->bindParam(':id', $id, PDO::PARAM_INT);
    $stmt->execute();
    ...
    // For dev: echo "Database error: " . $ex->getMessage();
    echo "Database error.";
    exit; 
}
?>
...
<title>Update Medicine | Aroroy PIS</title>
...
<div class="main-content">
    ...
    <div class="top-header">
        <div class="page-breadcrumb">
            <h1><i class="fas fa-pills" style="color: var(--teal); margin-right: 12px;"></i>Update Medicine Name</h1>
        </div>
...
<div class="page-body">
    ...
    <div class="update-card">
        <div class="update-card-header">
            <div class="update-card-header-icon">
                <i class="fas fa-edit"></i>
            </div>
            <h3>Edit Medicine Name</h3>
        </div>
        ...
        <div class="update-card-body">
            <form method="post">
                ...
                <div class="button-group">
                    <button type="submit" name="save_medicine" class="btn-update">
                        <i class="fas fa-sync-alt"></i> UPDATE
                    </button>

                    <a href="medicines.php" class="btn-cancel">
                        CANCEL
                    </a>
                </div>
            </form>
