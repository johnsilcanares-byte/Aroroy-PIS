...
?>
<aside class="main-sidebar sidebar-light-info elevation-4" style="background-color: #e3f2fd !important;">
    <a href="./" class="brand-link logo-switch" style="background-color: #bbdefb; color: #090909;">
      <h4 class="brand-image-xl logo-xs mb-0 text-center"><b>PMS</b></h4>
      <h3 class="brand-image-xl logo-xl mb-0 text-center">Aroroy <b>PMS</b></h3>
    </a>
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="color: #01579b; font-weight: 600;"><?php echo $_SESSION['display_name'];?></a>
        </div>
      </div>
