...
if(isset($_POST['submit'])) {
  ...
  $query = "update `medicine_details` set `medicine_id` = $medicineId, `packing` = '$packing' where `id` = $id;";
  try {
...
// Get existing data from URL parameters
$medicine_id = $_GET['medicine_id'];
$medicine_detail_id = $_GET['medicine_detail_id'];
$packing = $_GET['packing'];

$medicines = getMedicines($con, $medicine_id);
...
<head>
    ...
    <title>Update Medicine Details | Aroroy PIS</title>
...
<div class="main-content">
    ...
    <div class="top-header">
        <div class="page-breadcrumb">
            <h1><i class="fas fa-pills" style="color: var(--teal); margin-right: 12px;"></i>Update Medicine Details</h1>
        </div>
    ...
    <div class="page-body">
        ...
        <div class="update-card">
            <div class="update-card-header">
                <div class="update-card-header-icon"><i class="fas fa-edit"></i></div>
                <h3>Edit Packing Information</h3>
            </div>
            <div class="update-card-body">
                <form method="post">
                    <input type="hidden" name="hidden_id" value="<?php echo $medicine_detail_id; ?>" />
                    
                    <div class="form-row-custom">
                        <div class="form-group-custom">
                            <label class="form-label-custom">Select Medicine</label>
                            <select id="medicine" name="medicine" class="form-control-custom" required>
                                <?php echo $medicines;?>
                            </select>
                        </div>
                        ...
                        <div class="form-group-custom">
                            ...
                            <input id="packing" name="packing" class="form-control-custom" 
                            value="<?php echo $packing; ?>" required />
                        </div>
                    </div>
                    ...
                    <div class="button-group">
                        ...
                        <a href="medicine_details.php" class="btn-cancel">
...
<script>
    ...
    $(document).ready(function() {
        // Highlights the correct sidebar menu
